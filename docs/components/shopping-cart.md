...
- Meeting addition/removal tooltips name the class schedule so they cannot be mistaken for cart actions; both use a plain sentence ending with "since you last checked".
