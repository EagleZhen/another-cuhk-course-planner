...
- **A card breathes on arrival** when it shows content no earlier week did — a section starting, or one whose room, instructor or time changed. `GEWS1011`'s lecture changes building between weeks 1 and 2, which nothing else reveals.
