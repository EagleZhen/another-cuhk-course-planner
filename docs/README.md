...
- [components/weekly-calendar.md](components/weekly-calendar.md): WeeklyCalendar invariants, week selection, and ICS export/undo rationale
- [components/shopping-cart.md](components/shopping-cart.md): ShoppingCart cycling constraints, meeting rows, and change detection
