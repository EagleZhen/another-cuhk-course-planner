...
def test_render_scrape_time_module():
    assert (
        render_scrape_time_module("2026-07-18T00:41:13.631806+00:00")
        == """/**
 * Oldest scrape time across published subjects, so it holds for all of them.
 * Auto-generated by scripts/publish_course_data.py.
 */
export const SCRAPED_AT: string = '2026-07-18T00:41:13.631806+00:00'
"""
    )
