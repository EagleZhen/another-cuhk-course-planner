...
def test_render_scrape_times_module_is_deterministic():
    content = render_scrape_times_module(
        {"2026-27": "2027-01-04T02:10:11+00:00", "2025-26": "2026-07-18T00:41:13+00:00"}
    )
...
export const SCRAPED_AT_BY_YEAR: Record<string, string> = {
  ...
  '2026-27': '2027-01-04T02:10:11+00:00',
} as const
"""
    )
